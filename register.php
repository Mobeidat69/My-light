            ...
            <div class="signup-content">
                <div class="signup-form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="last-name"><i class="zmdi zmdi-account"></i></label>
                        ...
                        <div class="form-group">
                            <label class="dob-label" for="dob"></label>
                            <div class="dob-inputs">
                                <input type="number" name="dob-day" id="dob-day" placeholder="Day" min="1" max="31" required/>
                                <input type="number" name="dob-month" id="dob-month" placeholder="Month" min="1" max="12" required/>
                                <input type="number" name="dob-year" id="dob-year" placeholder="Year" min="1900" max="2023" required/>
                            </div>
                        </div>
